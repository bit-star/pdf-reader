...
To build the final jar and optimize the pdfReader application for production, run:
...
Then navigate to [http://localhost:8062](http://localhost:8062) in your browser.
