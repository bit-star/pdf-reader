package com.lazulite.pdfreader.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.lazulite.pdfreader.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.lazulite.pdfreader.repository.UserRepository.USERS_BY_EMAIL_CACHE);
